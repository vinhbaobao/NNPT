...
// @desc: Giáo viên tạo tài khoản mới cho sinh viên
// @access: Chỉ giáo viên được thực hiện
export const createStudentAccount = async (req, res) => {
  ...
  try {
    ...
    // Nếu người dùng hợp lệ -> lưu vào cơ sở dữ liệu
...
export const createTeacherAccount = async (req, res) => {
  const { username, password, lop, name } = req.body;
