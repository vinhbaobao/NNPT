      ...
      <div id='main'>
        <div className='homepage'>
          <p className='elements' id='title'>
            Classe<span id='student'>2023</span>
          </p>
          ...
          <div className='introduction'>
            ...
            <p id='_intro1'>
            Classe2023 là 1 phần mềm tiện ích giúp quản lý sinh viên một cách
            ...
            <div className='footer1'>
              ...
              <p id='_footer2'>
                ...
                động hành chính và học tập của họ. Classe2023 cung cấp một giải
            ...
            <div className='footer2'>
              <hr className='elements' id='homehr' />
              <h1 id='_footer1'>Các tính năng của Classe2023</h1>
